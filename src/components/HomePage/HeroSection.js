...
export default function HeroSection() {
  return (
    <div className="relative flex items-center justify-center min-h-screen pt-[118px]  bg-hero-background bg-fixed bg-center bg-cover bg-no-repeat">
      <div className="flex flex-col justify-center items-center gap-8 px-5 md:px-0 ">
        ...
        <p className="w-full md:w-2/5 text-[22px] text-center font-light text-[#c1c1c1]">
      ...
      <div className="absolute bottom-[-185px] md:left-[-.8%] w-full h-[250px] content-[''] bg-[#f8f8f8] shadow-[0_-44px_30px_0_rgba(0,0,0,.1)] transform rotate-[5deg] transition-transform duration-500"></div>
    </div>
  );
}
